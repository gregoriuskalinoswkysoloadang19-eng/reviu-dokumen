      ...
      <div className="min-h-screen flex items-center justify-center p-4"
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
            ...
            <div className="flex justify-center mb-4">
              <div className="w-24 h-24 rounded-full bg-white p-1.5 shadow-lg overflow-hidden flex items-center justify-center">
                ...
                <img
                  ...
                  width={84}
                  height={84}
                  style={{objectFit:'contain', width:'84px', height:'84px'}}
                  onError={(e)=>{
                    ...
                    if(parent) {
                      parent.innerHTML = '<div style="width:84px;height:84px;background:linear-gradient(135deg,#1d4ed8,#15803d);border-radius:50%;display:flex;align-items:center;justify-content:center;"><span style="font-size:32px">🏛️</span></div>'
                    }
                  }}
                />
              </div>
          ...
          <div className="px-8 py-6">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <button type="submit" disabled={loading}
                className="w-full py-2.5 rounded-lg text-sm font-semibold text-white transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-2 flex items-center justify-center gap-2"
          ...
          <div className="px-8 pb-6 text-center">
            <p className="text-xs text-gray-400">© 2025 Inspektorat Kabupaten Sumba Barat</p>
